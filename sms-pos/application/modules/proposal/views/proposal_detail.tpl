                ...
                <table class="table">
                    ...
                    {foreach $items as $key }
                        <tr>
                            ...
                            {if $cache['value']['status_ppn'] == 1}
                                <td style="width:130px;" class="text-right">
                                    Rp {( ($key['qty'] * ($key['price'] - $key['discount']))*0.1)|number_format:0}
                            {/if}
                            <td style="width:130px;" class="text-right">
                                Rp {($key['qty'] * ($key['price'] - $key['discount'])
                                +( ($key['qty'] * ($key['price'] - $key['discount']))*0.1))|number_format:0}
                            </td>
                            <td style="width:90px;">
                        ...
                        <div class="col-sm-4 pull-right">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <th>PPn:</th>
                                    <td class="text-right">Rp
                                        <span id="sum-ppn-text"><strong> {$ppn|number_format:0}</strong> </span>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
